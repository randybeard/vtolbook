...
class QuadrotorDynamics:
    ...
    def update(self, delta):
        ...
        x1 = self._f(self._state, delta)
        x2 = self._f(self._state + time_step/2.*x1, delta)
        x3 = self._f(self._state + time_step/2.*x2, delta)
        x4 = self._f(self._state + time_step*x3, delta)
