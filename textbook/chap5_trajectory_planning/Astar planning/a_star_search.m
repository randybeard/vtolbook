...
% a_star_search.m
% 
% An implmentation of the MATLAB A* search function
% 
% A* ALGORITHM Demo
...
function [Optimal_path] = a_star_search(MAX_X, MAX_Y, MAP, xStart, yStart, xTarget, yTarget)

% Initialize xval,yval with coordinates of starting location
xval = xStart;
yval = yStart;
