...
gravity = SYS.gravity  # gravity constant
mass = SYS.mass
J = SYS.J

#----------control gains-------------
Kp_angular_rate = np.diag([100.0, 100.0, 100.0])  # gains for angular rate regulation
Kp_attitude_simple = np.diag([10.0, 10.0, 10.0])  # gain for attitude control
Kd_velocity = np.diag([1.0, 1.0, 1.0])


#
# rho = SYS.rho  # density of air
