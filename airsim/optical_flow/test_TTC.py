...
from optical_flow.time_to_collision import TimeToCollision

"""Test time to collision (TTC). Same as test of Jake's controller with optical flow running in the background"""
...
collision_detector = TimeToCollision()
...
while sim_time < SIM.end_time:
    ...
    tau = collision_detector.compute_time(img, SIM.ts_simulation, draw=True)
    print(tau)
